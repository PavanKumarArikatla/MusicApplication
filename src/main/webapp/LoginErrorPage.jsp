...
<body style="background-color: rgb(30,30,30); color: white; font-family: arial;">
	...
	<form action="ForgotPassword">
		<input type="submit" value="Forgot your password?" style="background-color: black; color: white; border: 1px solid black; text-decoration: underline; margin: 20px 110px;">
	</form>
